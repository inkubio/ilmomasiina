...
config.globals = {
  ...
  BRANDING_FOOTER_CREDIT_TEXT: JSON.stringify(process.env.BRANDING_FOOTER_CREDIT_TEXT),
  BRANDING_FOOTER_CREDIT_LINK: JSON.stringify(process.env.BRANDING_FOOTER_CREDIT_LINK),
};
